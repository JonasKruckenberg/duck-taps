[duck-taps - v1.1.0](../README.md) › [AsyncSeriesHook](asyncserieshook.md)
...
*Defined in [lib/AsyncSeriesHook.ts:10](https://github.com/JonasKruckenberg/duck-taps/blob/bf28a82/lib/AsyncSeriesHook.ts#L10)*
